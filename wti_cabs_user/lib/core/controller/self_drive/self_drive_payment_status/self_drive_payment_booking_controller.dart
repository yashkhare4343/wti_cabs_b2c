...
class SelfDrivePaymentBookingController extends GetxController {
  ...
  // Success
  Future<void> fetchPaymentBookingDetails() async {
    print("🔄 [fetchPaymentBookingDetails] Started for orderRef: ${sdCreateStripePaymentController.orderReferenceNo.value}");
