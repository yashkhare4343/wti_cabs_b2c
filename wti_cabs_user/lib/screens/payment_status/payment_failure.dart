                ...
                child: Obx(() {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text('Booking Failed', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                      SizedBox(height: 8),
                      Text('Something went wrong, Please try again!', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey.shade600)),
                      SizedBox(height: 24),
