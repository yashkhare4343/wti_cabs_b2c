...
class SelfDrivePlaceMap extends StatefulWidget {
  ...
  @override
  State<SelfDrivePlaceMap> createState() => _SelfDrivePlaceMapState();
}

class _SelfDrivePlaceMapState extends State<SelfDrivePlaceMap> {
