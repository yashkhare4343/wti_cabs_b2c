...
import '../self_drive_pickup_map/self_drive_return_map.dart';

class SelfDriveReturnPopularLocation extends StatefulWidget {
  final String vehicleId;
  final bool isHomePage;
  const SelfDriveReturnPopularLocation(
      {super.key, required this.vehicleId, required this.isHomePage});

  @override
  State<SelfDriveReturnPopularLocation> createState() =>
      _SelfDriveReturnPopularLocationState();
}

class _SelfDriveReturnPopularLocationState
    extends State<SelfDriveReturnPopularLocation> {
                      ...
                      onTap: () async {
                        await googleLatLngController
                          ...
                          Navigator.of(context).push(
                            Platform.isIOS
                                ? CupertinoPageRoute(
                              builder: (_) => SelfDriveReturnPlaceMap(
