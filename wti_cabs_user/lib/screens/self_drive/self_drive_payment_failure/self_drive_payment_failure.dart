...
class PaymentReservationFailure extends StatefulWidget {
  const PaymentReservationFailure({super.key,});

  @override
  State<PaymentReservationFailure> createState() => _PaymentReservationFailureState();
}

class _PaymentReservationFailureState extends State<PaymentReservationFailure> {
  final SelfDrivePaymentBookingController selfDrivePaymentBookingController = Get.put(SelfDrivePaymentBookingController());

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    selfDrivePaymentBookingController.fetchPaymentFailureBookingDetails();
  }
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Something went wrong with your booking. Try again.',
